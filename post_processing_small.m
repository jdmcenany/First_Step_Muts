...
for i = 1:20
    for i2 = 1:4
        fname = "Raw_Results_Small/Assembly_Sims/alpha_epsilon_params/comm_alpha_" + string(alpha_vals(i)) + "_epsilon_" + string(epsilon_vals(i2)) + "_R0_40_R_200_sigmaR2_0.mat";
        load(fname)
        for j = 1:size(harvests,1)
            h = harvests{j};
            d = deltas{j};
...
save('Processed_Results_Small/Fig2B_data','alpha_vals','astar_means','astar_stds','alpha_vals_theory','astar_vals_theory')
...
fname = "Raw_Results_Small/Assembly_Sims/astar_phi_params/comm_astar_0.9_phi_0.1_R0_40_R_200_sigmaR2_0.mat";
load(fname)
for i = 1:size(harvests,1)
    h = harvests{i};
    h = length(h)*h/sum(h);
...
fname = "Raw_Results_Small/Assembly_Sims/astar_phi_params/comm_astar_0.5_phi_0.1_R0_40_R_200_sigmaR2_0.mat";
load(fname)
for i = 1:size(harvests,1)
    h = harvests{i};
    h = length(h)*h/sum(h);
...
save('Processed_Results_Small/Fig2C_data.mat','edges','h1','h2','h3','h4','x_vals','S_inv_vals1','S_inv_vals2')
close all
...
for i = 1:19
    for i2 = 1:2
        fname = "Raw_Results_Small/Assembly_Sims/astar_phi_params/comm_astar_" + string(astar_vals(i)) + "_phi_" + string(phi_vals(i2)) + "_R0_10_R_200_sigmaR2_0.mat";
        load(fname)
...
for i = 1:19
    for i2 = 1:2
        fname = "Raw_Results_Small/Assembly_Sims/astar_phi_params/comm_astar_" + string(astar_vals(i)) + "_phi_" + string(phi_vals(i2)) + "_R0_100_R_200_sigmaR2_0.mat";
        load(fname)
        for i3 = 1:length(harvests)
            all_fitnesses = zeros(R^2,1);
            ind = 1;
...
save('Processed_Results_Small/Fig2D_data','astar_actual','astar_vals','alpha_star','sigma_invs','sigma_inv1','sigma_inv2','sigma_inv3','sigma_inv4')
...
for i = 1:9
    for i2 = 1:5
        fname = "Raw_Results_Small/Assembly_Sims/astar_phi_params/comm_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_sigmaR2_" + string(sigmaR2_vals(i2)) + ".mat";
        load(fname)
        for i3 = 1:length(harvests)
            h = harvests{i3};
            h = length(h)*h/sum(h);
...
save('Processed_Results_Small/Fig2E_data','astarvals','astar_actual','alpha_star','all_corrs','corr_theory')
...
R0=40;
for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_" + string(astarvals(i)) + "_phi_0.5_R0_40_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/Fig3A_data.mat','alpha_star_vals','astar_actual1','astar_actual2', 'cprob1','cprob2', 'astarvals','coex1','tot1','coex2','tot2')
...
for i = 1:9
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.3_phi_0.1_R0_" + string(R0_vals(i)) + "_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
for i = 1:9
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.8_phi_0.1_R0_" + string(R0_vals(i)) + "_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
    load(fname)
...
save('Processed_Results_Small/Fig3B_data.mat','R0', 'cprob1','cprob2','R0_vals','coex1','tot1','coex2','tot2')
...
R0=40;
for i = 1:11
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.3_phi_0.1_R0_40_R_200_dx_" +string(deltaxvals(i)) + "_sigmaR2_0_muttype_-1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
for i = 1:11
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.8_phi_0.1_R0_40_R_200_dx_" +string(deltaxvals(i)) + "_sigmaR2_0_muttype_-1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/Fig3C_data.mat','alpha_star_vals', 'pcoex_vals1','pcoex_vals2','coex1','tot1','coex2','tot2')
...
fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.3_phi_0.1_R0_40_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
load(fname)
...
fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.8_phi_0.1_R0_40_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
load(fname)
for k = 1:size(organisms,1)
    h = harvests{k,1};
    d = deltas{k,2};
...
save('Processed_Results_Small/Fig3C_inset_data.mat','S_inv_vals','coex_theory1','coex_theory2','x_vals1','x_vals2','cprobs')
...
R0=16;
for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_16_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
R0=40;
fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_" + string(astarvals(9)) + "_phi_0.1_R0_40_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
load(fname)
for k = 1:size(organisms,1)
    h = harvests{k,1};
    d = deltas{k,2};
...
tot2=1;
R0 = 16;
fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_" + string(astarvals(9)) + "_phi_0.1_R0_16_R_200_dx_0_sigmaR2_0_muttype_-1.mat";
load(fname)
for k = 1:size(organisms,1)
    h = harvests{k,1};
    d = deltas{k,2};
...
save('Processed_Results_Small/Fig4D_data.mat','all_abuns','all_extinct','edges','ext_probs','ext_probs_err')
...
for i = 1:length(R0_vals)
    tot=1;
    R0 = R0_vals(i);
    fname = "Raw_Results_Small/First_Step_Sims/knockin/sstep_astar_0.8_phi_0.1_R0_" + string(R0_vals(i)) + "_R_200_dx_0_sigmaR2_0_muttype_0.mat";
    load(fname)
    for k = 1:size(organisms,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/Fig4E_data.mat','totals','R0_vals')
...
load("Raw_Results_Small/Multi_Step_Sims/mstep_astar_0.9_phi_0.1_R0_20_R_100_dx_0_" + string(load_ind) + ".mat")
...
save('Processed_Results_Small/Fig5A_right_data.mat','h1','h2','h3','edges')
close all
...
for i = [3 4]
    load("Raw_Results_Small/Multi_Step_Sims/mstep_astar_0.9_phi_0.1_R0_20_R_100_dx_0_" + string(i) + ".mat")
...
save('Processed_Results_Small/Fig5B_data.mat','N_strains','N_species','min_len','max_len')
...
for k = [3 4]
    species0 = 1:4500;
    load("Raw_Results_Small/Multi_Step_Sims/mstep_astar_0.9_phi_0.1_R0_20_R_100_dx_0_" + string(k) + ".mat")
    for i = 1:(length(all_abundances)-1)
        extinct_strains = setdiff(species_present{i},species_present{i+1});
...
save('Processed_Results_Small/Fig5C_data.mat','survival_prob')
...
save('Processed_Results_Small/Fig5D_data.mat','edges','h1','h3','x_vals','R0','S_inv_vals1')
close all
...
tot = 0;
R0=20;
fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.9_phi_0.1_R0_20_R_100_dx_0_sigmaR2_0_muttype_-1.mat";
load(fname)
for k = 1:size(harvests,1)
    h = harvests{k,1};
    d = deltas{k,2};
...
save('Processed_Results_Small/Fig5E_data.mat','coex_flag','cprob1')
...
save('Processed_Results_Small/FigS1_data.mat','t1','n1','c1','abundances_1','n_dynamics_1','c_half','h_max','h2_1','h_dynamics_1','abundances_2','n_dynamics_2','h2_2','h_dynamics_2')
...
fname = "Raw_Results_Small/Assembly_Sims/astar_phi_params/comm_astar_0.8_phi_0.1_R0_40_R_200_sigmaR2_0.mat";
load(fname)
for i = 1:1
    h = harvests{i};
    h = length(h)*h/sum(h);
...
save('Processed_Results_Small/FigS2_data.mat','edges2','h5','h6','x_vals','S_inv_vals3')
close all
...
R0=40;
for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_alttype_2_gamma_1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
h1Vals = h1.Values;
h2Vals = h2.Values;
save('Processed_Results_Small/FigS3A_data','edges','h1Vals','h2Vals','x_vals','S_inv_vals1','S_inv_vals2')
close all
...
save('Processed_Results_Small/FigS3B_data','alpha_star_vals','astar_actual', 'cprob', 'astarvals','coex','tot')
...
R = 200;
for i = 1:8
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_gauss_uptakes_alpha_" + string(alphavals(i)) + "_eps_1_scale_10_R_200_mutsize_0.1.mat";
    load(fname)
...
R = 200;
for i = 1:8
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_gauss_uptakes_alpha_" + string(alphavals(i)) + "_eps_1_scale_100_R_200_mutsize_0.1.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
R = 200;
for i = 1:8
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_gauss_uptakes_alpha_" + string(alphavals(i)) + "_eps_1_scale_10_R_200_mutsize_0.05.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
R = 200;
for i = 1:8
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_gauss_uptakes_alpha_" + string(alphavals(i)) + "_eps_1_scale_100_R_200_mutsize_0.05.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
save('Processed_Results_Small/FigS3C_data','alpha_star_vals','cprob','cprob2','astar_actual1','astar_actual2','astar_actual3','astar_actual4','coex1','coex2','coex3','coex4','tot1','tot2','tot3','tot4')
...
save('Processed_Results_Small/FigS3D_data','Ksource_vals','Krecip_vals','coex_flag','invasion_flag','gamma','prop','R')
...
R0=40;
for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/simul_assembly/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_dx_0_sigmaR2_0_muttype_1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/FigS4_data','alpha_star_vals','astar_actual1','astar_actual2', 'cprob', 'astarvals','coex1','coex2','tot1','tot2')
...
R0=40;
 for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_alttype_3_gamma_1.mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/FigS5_left_data','alpha_star_vals','astar_actual1','astar_actual2', 'cprob', 'astarvals','coex1','coex2','tot1','tot2')
...
R0=40;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_astar_0.8_phi_0.1_R0_40_R_200_alttype_2_gamma_" + string(gammavals(i)) +".mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
R0=40;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/dirichlet_uptakes/sstep_astar_0.8_phi_0.1_R0_40_R_200_alttype_3_gamma_" + string(gammavals(i)) +".mat";
    load(fname)
    for k = 1:size(harvests,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/FigS5_right_data','gammavals', 'cprob','coex1','coex2','tot1','tot2')
...
save('Processed_Results_Small/FigS6_data','s_invs','rel_abuns','coex_flags');
...
R0=40;
for i = 1:9
    fname = "Raw_Results_Small/First_Step_Sims/knockout/sstep_astar_0.8_phi_0.1_R0_40_R_200_dx_0_sigmaR2_" + string(sigmaR2_vals(i)) + "_muttype_-1.mat";
...
save('Processed_Results_Small/FigS7A_data','coex1','tot1','sigmaR2_vals','cprob');
...
R = 150;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/exponential_supply/sstep_wide_resource_var_alpha_" + string(alphavals(i)) + "_eps_0.1_R0_30_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/exponential_supply/sstep_wide_resource_var_alpha_" + string(alphavals(i)) + "_eps_1_R0_30_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/exponential_supply/sstep_wide_resource_var_alpha_" + string(alphavals(i)) + "_eps_5_R0_30_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
save('Processed_Results_Small/FigS7B_data.mat','astar_actual1','astar_actual2','astar_actual3','tot1','tot2','tot3','coex1','coex2','coex3','alpha_star_vals','cprob')
...
save('Processed_Results_Small/FigS7C_data.mat','x_vals','S_inv_vals1B','S_inv_vals2B','h1','h2')
close all
...
fname = "Raw_Results_Small/First_Step_Sims/metabolic_tradeoffs/sstep_astar_0.8_phi_0.1_R0_40_R_200_alttype_0.mat";
load(fname)
...
save('Processed_Results_Small/FigS8A_data.mat','edges','h1','h2','x_vals','R0','S_inv_vals1')
close all
...
R0=40;
for i = 1:13
    fname = "Raw_Results_Small/First_Step_Sims/metabolic_tradeoffs/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_alttype_0.mat";
    load(fname)
    for k = 1:size(deltas,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
for i = 1:13
    fname = "Raw_Results_Small/First_Step_Sims/metabolic_tradeoffs/sstep_astar_" + string(astarvals(i)) + "_phi_0.1_R0_40_R_200_alttype_1.mat";
    load(fname)
    for k = 1:size(deltas,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/FigS8B_data.mat','alpha_star_vals','astar_actual1','astar_actual2','pcoex_vals1','pcoex_vals2','pcoex_vals3','coex1','tot1','coex2','tot2')
...
R = 150;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/metabolic_tradeoffs/sstep_no_tradeoffs_alpha_" + string(alphavals(i)) + "_eps_0.1_R0_30_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/metabolic_tradeoffs/sstep_no_tradeoffs_alpha_" + string(alphavals(i)) + "_eps_1_R0_30_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/metabolic_tradeoffs/sstep_no_tradeoffs_alpha_" + string(alphavals(i)) + "_eps_5_R0_30_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
save('Processed_Results_Small/FigS8C_data.mat','h1','h2','x_vals','S_inv_vals1','S_inv_vals2','-v7.3')
save('Processed_Results_Small/FigS8D_data.mat','astar_actual1','astar_actual2','astar_actual3','tot1','tot2','tot3','coex1','coex2','coex3','alpha_star_vals','cprob','-v7.3')
...
R0=40;
for i = 1:14
    fname = "Raw_Results_Small/First_Step_Sims/R0_variation/sstep_astar_0.8_phi_0.1_R0_40_R_200_Rp_" + string(Rp_vals(i))+ ".mat";
    load(fname)
    for k = 1:size(deltas,1)
        h = harvests{k,1};
        d = deltas{k,2};
...
save('Processed_Results_Small/FigS9A_data','coex2','tot2','Rp_vals','cprob');
...
R = 150;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/R0_variation/sstep_wide_R0_variation_alpha_" + string(alphavals(i)) + "_eps_0.1_R0_20_to_130_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
R = 150;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/R0_variation/sstep_wide_R0_variation_alpha_" + string(alphavals(i)) + "_eps_1_R0_20_to_130_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
R = 150;
for i = 1:10
    fname = "Raw_Results_Small/First_Step_Sims/R0_variation/sstep_wide_R0_variation_alpha_" + string(alphavals(i)) + "_eps_5_R0_20_to_130_R_150.mat";
    load(fname)
    for k = 1:length(harvests)
        h = harvests{k,1};
        h = length(h)*h/sum(h);
...
if length(unique(astar_actual3./tot3)) < length(astar_actual3)
    astar_actual3 = astar_actual3.*normrnd(1,0.01,length(astar_actual3),1);
end
...
Rp_vals = max(1,interp1(astar_actual2./tot2,Rp_vals,alpha_star_vals,'linear','extrap'));
phi = (astar_actual2./tot2)./alphavals';
lmbda = sqrt(2)*erfinv(1-2*phi);
lmbda = interp1(astar_actual2./tot2,lmbda,alpha_star_vals,'linear','extrap');
phi = erfc(lmbda/sqrt(2))/2;
...
Rp_vals = max(1,interp1(astar_actual1./tot1,Rp_vals,alpha_star_vals,'linear','extrap'));
...
save('Processed_Results_Small/FigS9B_data','cprob1','cprob2','cprob3','alpha_star_vals1','alpha_star_vals2','alpha_star_vals3','astar_actual1','astar_actual2','astar_actual3','coex1','coex2','coex3','tot1','tot2','tot3');
...
save('Processed_Results_Small/FigS9C_data','h1','h2');
close all
i1 = 1;
i2 = 5;
...
save('Processed_Results_Small/FigS9D_data','S_inv_vals1','S_inv_vals2','x_vals','h1','h2');
close all
...
save('Processed_Results_Small/FigS10_data','threshold_vals','putative_survivors','tots','all_deltas','ext_flags','par_flags');
